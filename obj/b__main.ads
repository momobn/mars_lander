...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#2aa684f6#;
   ...
   u00005 : constant Version_32 := 16#64176fe3#;
   ...
   u00129 : constant Version_32 := 16#ac0b64a5#;
   ...
   u00149 : constant Version_32 := 16#d23c0bd2#;
   pragma Export (C, u00149, "displayS");
   u00150 : constant Version_32 := 16#2bda477c#;
   pragma Export (C, u00150, "sdl_surface_hS");
   u00151 : constant Version_32 := 16#b729b22d#;
   pragma Export (C, u00151, "sdl_blendmode_hS");
   u00152 : constant Version_32 := 16#9fc0eb73#;
   pragma Export (C, u00152, "sdl_pixels_hS");
   u00153 : constant Version_32 := 16#3cb6e6b8#;
   pragma Export (C, u00153, "sdl_stdinc_hS");
   u00154 : constant Version_32 := 16#bde814a5#;
   pragma Export (C, u00154, "stdarg_hS");
   u00155 : constant Version_32 := 16#aacab6e3#;
   pragma Export (C, u00155, "stddef_hS");
   u00156 : constant Version_32 := 16#5e5671b5#;
   pragma Export (C, u00156, "interfaces__c__extensionsS");
   u00157 : constant Version_32 := 16#5b9c1086#;
   pragma Export (C, u00157, "stdint_hS");
   u00158 : constant Version_32 := 16#7f24f6ad#;
   pragma Export (C, u00158, "sdl_rect_hS");
   u00159 : constant Version_32 := 16#06bea2d4#;
   pragma Export (C, u00159, "sdl_rwops_hS");
   u00160 : constant Version_32 := 16#f0ea582e#;
   pragma Export (C, u00160, "display__basicB");
   u00161 : constant Version_32 := 16#5c5c255f#;
   pragma Export (C, u00161, "display__basicS");
   u00162 : constant Version_32 := 16#d84b68c7#;
   pragma Export (C, u00162, "display__basic__fontsB");
   u00163 : constant Version_32 := 16#7d6ee5b9#;
   pragma Export (C, u00163, "display__basic__fontsS");
   u00164 : constant Version_32 := 16#a3aa4cc4#;
   pragma Export (C, u00164, "sdl_video_hS");
   u00165 : constant Version_32 := 16#0ef41a26#;
   pragma Export (C, u00165, "display__basic__utilsB");
   u00166 : constant Version_32 := 16#c169a61f#;
   pragma Export (C, u00166, "display__basic__utilsS");
   u00167 : constant Version_32 := 16#4080b80b#;
   pragma Export (C, u00167, "display__basic__glfontsB");
   u00168 : constant Version_32 := 16#17481176#;
   pragma Export (C, u00168, "display__basic__glfontsS");
   u00169 : constant Version_32 := 16#1e0d12ec#;
   pragma Export (C, u00169, "gl_gl_hS");
   u00170 : constant Version_32 := 16#cafbcd5b#;
   pragma Export (C, u00170, "gl_glu_hS");
   u00171 : constant Version_32 := 16#5d73a81c#;
   pragma Export (C, u00171, "sdl_error_hS");
   u00172 : constant Version_32 := 16#8674788c#;
   pragma Export (C, u00172, "sdl_events_hS");
   u00173 : constant Version_32 := 16#b5072ac9#;
   pragma Export (C, u00173, "sdl_gesture_hS");
   u00174 : constant Version_32 := 16#fb5ea3be#;
   pragma Export (C, u00174, "sdl_touch_hS");
   u00175 : constant Version_32 := 16#d4dcb331#;
   pragma Export (C, u00175, "sdl_joystick_hS");
   u00176 : constant Version_32 := 16#40f2cc6f#;
   pragma Export (C, u00176, "sdl_keyboard_hS");
   u00177 : constant Version_32 := 16#8671682b#;
   pragma Export (C, u00177, "sdl_keycode_hS");
   u00178 : constant Version_32 := 16#f1942ea3#;
   pragma Export (C, u00178, "sdl_scancode_hS");
   u00179 : constant Version_32 := 16#5c9e3cb7#;
   pragma Export (C, u00179, "sdl_hS");
   u00180 : constant Version_32 := 16#20fb1be0#;
   pragma Export (C, u00180, "mars_landerB");
   u00181 : constant Version_32 := 16#06829563#;
   pragma Export (C, u00181, "mars_landerS");
   u00182 : constant Version_32 := 16#e50f2660#;
   pragma Export (C, u00182, "collisionB");
   u00183 : constant Version_32 := 16#65ff8504#;
   pragma Export (C, u00183, "collisionS");
   u00184 : constant Version_32 := 16#8c80aaf6#;
   pragma Export (C, u00184, "display__imageB");
   u00185 : constant Version_32 := 16#bcca895f#;
   pragma Export (C, u00185, "display__imageS");
   ...
   u00189 : constant Version_32 := 16#f508d0da#;
   ...
   u00200 : constant Version_32 := 16#ff485338#;
   ...
   u00212 : constant Version_32 := 16#43cda1ce#;
   pragma Export (C, u00212, "system__tasking__queuingB");
   u00213 : constant Version_32 := 16#6dba2805#;
   ...
   u00216 : constant Version_32 := 16#1e07ca19#;
   ...
   u00218 : constant Version_32 := 16#81cfd647#;
   pragma Export (C, u00218, "terrainB");
   u00219 : constant Version_32 := 16#99aa8a03#;
   pragma Export (C, u00219, "terrainS");
   u00220 : constant Version_32 := 16#cd2959fb#;
   pragma Export (C, u00220, "ada__numericsS");
   u00221 : constant Version_32 := 16#947defa3#;
   pragma Export (C, u00221, "perlinB");
   u00222 : constant Version_32 := 16#65fe9455#;
   pragma Export (C, u00222, "perlinS");
   u00223 : constant Version_32 := 16#03e83d1c#;
   pragma Export (C, u00223, "ada__numerics__elementary_functionsB");
   u00224 : constant Version_32 := 16#edc89b7f#;
   pragma Export (C, u00224, "ada__numerics__elementary_functionsS");
   u00225 : constant Version_32 := 16#e5114ee9#;
   pragma Export (C, u00225, "ada__numerics__auxB");
   u00226 : constant Version_32 := 16#9f6e24ed#;
   pragma Export (C, u00226, "ada__numerics__auxS");
   u00227 : constant Version_32 := 16#5fc82639#;
   pragma Export (C, u00227, "system__machine_codeS");
   u00228 : constant Version_32 := 16#b2a569d2#;
   pragma Export (C, u00228, "system__exn_llfB");
   u00229 : constant Version_32 := 16#8ede3ae4#;
   pragma Export (C, u00229, "system__exn_llfS");
   u00230 : constant Version_32 := 16#6ad59d2c#;
   pragma Export (C, u00230, "system__fat_fltS");
   u00231 : constant Version_32 := 16#ec9cfed1#;
   pragma Export (C, u00231, "system__random_numbersB");
   u00232 : constant Version_32 := 16#f1b831a2#;
   pragma Export (C, u00232, "system__random_numbersS");
   u00233 : constant Version_32 := 16#15692802#;
   pragma Export (C, u00233, "system__random_seedB");
   u00234 : constant Version_32 := 16#69b0a863#;
   pragma Export (C, u00234, "system__random_seedS");
   u00235 : constant Version_32 := 16#fc54e290#;
   pragma Export (C, u00235, "ada__calendarB");
   u00236 : constant Version_32 := 16#31350a81#;
   pragma Export (C, u00236, "ada__calendarS");
   u00237 : constant Version_32 := 16#383fd226#;
   pragma Export (C, u00237, "system__val_unsB");
   u00238 : constant Version_32 := 16#33208002#;
   pragma Export (C, u00238, "system__val_unsS");
   u00239 : constant Version_32 := 16#46899fd1#;
   pragma Export (C, u00239, "system__concat_7B");
   u00240 : constant Version_32 := 16#ce67da27#;
   pragma Export (C, u00240, "system__concat_7S");
   u00241 : constant Version_32 := 16#a83b7c85#;
   pragma Export (C, u00241, "system__concat_6B");
   u00242 : constant Version_32 := 16#e067ac8a#;
   pragma Export (C, u00242, "system__concat_6S");
   u00243 : constant Version_32 := 16#608e2cd1#;
   pragma Export (C, u00243, "system__concat_5B");
   u00244 : constant Version_32 := 16#b5fec216#;
   pragma Export (C, u00244, "system__concat_5S");
   u00245 : constant Version_32 := 16#26cbc451#;
   pragma Export (C, u00245, "vectorB");
   u00246 : constant Version_32 := 16#ba7f46fe#;
   pragma Export (C, u00246, "vectorS");
   u00247 : constant Version_32 := 16#e31b7c4e#;
   pragma Export (C, u00247, "system__memoryB");
   u00248 : constant Version_32 := 16#6bdde70c#;
